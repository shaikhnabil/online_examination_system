...
if(isset($_SESSION["esc"]))
{
    ...
    foreach($result as $row)
    {
        $subject_to_class_id = $row["subject_to_class_id"];
...
$object->query = "
SELECT student_register.student_name, student_register.student_image, student_to_class.student_roll_no FROM student_to_class 
INNER JOIN student_register 
ON student_register.student_id = student_to_class.student_id 
WHERE student_to_class.student_id = '".$_SESSION["student_id"]."' 
ORDER BY student_to_class.student_to_class_id DESC 
LIMIT 1 
";
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header" style="background-color:#8548d2;color:#f3e9ff">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <b>Subject : </b><?php echo $object->Get_Subject_name($subject_to_class_id); ?>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card shadow">
                                        <div class="card-header" style="background-color:#8548d2;color:#f3e9ff"><b>Student Details</b></div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
...
//submit button
    $(document).on('click', '.submit', function(){
        ...
        $.ajax({
            url:"ajax_action.php",
            method:"POST",
            data:{question_id:question_id, answer_option:answer_option, exam_id:exam_id, exam_subject_id:exam_subject_id, page:'view_subject_exam', action:'submit'},
            success:function()
            {
                <?php //unset($_SESSION["esc"]);?>
                $("#exam_timer").TimeCircles().destroy();
                alert('Exam Submitted Successfully');
               location.href="student_dashboard.php?ec=<?php echo $_SESSION["ec"];?>";
