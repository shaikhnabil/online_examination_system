...
?>
                    ...
                    <!-- DataTables for display data of exam table-->
                        ...
                        <div class="card-header py-3" style="background-color:#8548d2;color:#f3e9ff;">
                        	<div class="row">
                            	...
                            	<div class="col" style="text-align: right;">
                            		<button type="button" name="add_exam" id="add_exam" class="btn btn-info btn-circle btn-sm"><i class="fas fa-plus"></i></button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
        ...
        <form method="post" id="publish_result_form">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="submit" id="result_publish_submit_button" class="btn btn-info" value="Publish" />
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
        </form>
...
//submit form for publishing result
