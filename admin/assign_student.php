...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color:#8548d2;color:#f3e9ff;">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold">Students List with Class Name</h6>
                            	</div>
                            	<div class="col" style="text-align: right;">
                                    <button type="button" name="assign_student" id="assign_student" class="btn btn-info btn-circle btn-sm"><i class="fas fa-plus"></i></button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
