            ...
            <!-- Footer -->
            <!-- <footer class="sticky-footer" style="background-color: #fff;color:#333;border-top:1px groove #8548d2;">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span style="font-size: 15px;">Copyright &copy; Online Exam <?php echo date('Y'); ?></span>
                    </div>
                </div>
            </footer> -->
            <!-- End of Footer -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Select "Logout" if you are sure to Logout.</div>
