...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			<button type="button" name="delete" class="btn btn-danger btn-circle  btn-sm delete_button" data-id="'.$row["class_id"].'"><i class="fas fa-trash-alt"></i></button>
			</div>
			';
			$data[] = $sub_array;
		}
...
//check action is add and add class into datatable
	if($_POST["action"] == 'Add')
	{
		$error = '';
...
//check action is fetch_single and send data to ajax request
...
//check action is edit and edit the datatables
...
//check action is change status and change the status enable or disable in datatable
