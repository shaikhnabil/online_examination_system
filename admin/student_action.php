...
//if action = fetch then send data
...
";
		...
		foreach($result as $row)
		{
			...
			<button type="button" name="delete_button" class="btn btn-danger btn-circle btn-sm delete_button" data-id="'.$row["student_id"].'"><i class="fas fa-trash-alt"></i></button>
			</div>
			';
			$data[] = $sub_array;
		}
