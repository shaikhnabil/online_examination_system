                        ...
                        <div class="card-header py-3 border border-bottom" style="background-color:#8548d2;color:#f3e9ff;">
                        	<div class="row">
                            	...
                            	<div class="col" style="text-align: right;">
                            		<button type="button" name="add_class" id="add_class" class="btn btn-info btn-circle btn-sm"><i class="fas fa-plus"></i></button>
                            	</div>
                            </div>
                        </div>
                        <div class="card-body">
...
//set fetch request to fetch class data 
...
//display add class modal
	...
	$('#class_form').parsley();
//submit data of add class modal
...
//enable or disable class status
